...
#
# USAGE:
#   # Use the built-in teaching example:
#   bash scripts/00_download_data.sh
#
#   # Use your own accession (recommended for students):
...
# You can edit values below after download if your project needs different
# Nanopore reads, genome size, BUSCO lineage, or annotation settings.
# =============================================================================
...
# Optional Nanopore long reads for hybrid assembly / scaffolding
NANOPORE="\${NANOPORE:-}"

# Approximate genome size in base pairs — adjust for your organism
GENOME_SIZE="\${GENOME_SIZE:-5000000}"

# Default draft assembly for polishing
...
# Optional example region for gene-product lookup in pipeline 2
...
# CPU threads — adjust for your machine
THREADS="\${THREADS:-6}"
...
echo ""
echo "  Next steps:"
echo "    1. If needed, edit config.sh for your organism"
echo "    2. Run: bash scripts/01_pipeline_hybrid.sh"
echo "       or:  bash scripts/02_pipeline_polish.sh"
echo ""
